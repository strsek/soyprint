...
btd <- readRDS("input_data/FABIO/FABIO_exp/v1/btd_full.rds") # für Preise --> einheitlicher Wert für BRA
cbs <- readRDS("intermediate_data/FABIO/cbs_full.rds") # für Soya schon mit Gemeinden
sup <- fread("input_data/FABIO/inst/items_supply.csv")
...
shares <- fread("input_data/FABIO/inst/items_supply-shares.csv")
...
# fill in milk prices
prices <- readRDS("input_data/FABIO/tidy/prices_tidy.rds")
